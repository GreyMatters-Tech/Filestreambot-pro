...
class Var(object):
    ...
    BIN_CHANNEL = int(getenv('BIN_CHANNEL', 'Chat id: -1001851178288'))
    ...
    DATABASE_URL = str(getenv('DATABASE_URL', 'mjco2kg.mongodb.net/?retryWrites=true&w=majority'))
    UPDATES_CHANNEL = str(getenv('UPDATES_CHANNEL', '-1001851178288'))
